...
CREATE TABLE `bookmarks` (
  ...
  CONSTRAINT `bookmarks_ibfk_2` FOREIGN KEY (`recipe_id`) REFERENCES `recipes` (`id`) ON DELETE CASCADE
...
INSERT INTO `bookmarks` VALUES (1,1,5,'2025-05-16 06:55:06'),(2,2,4,'2025-05-16 06:55:06');
